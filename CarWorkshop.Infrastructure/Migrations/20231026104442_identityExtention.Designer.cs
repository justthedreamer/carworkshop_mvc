...
namespace CarWorkshop.Infrastructure.Migrations
{
    ...
    [Migration("20231026104442_identityExtention")]
    partial class identityExtention
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarWorkshop.Domain.Entities.CarWorkshopRating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Shared.ApplicationUser.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("CarWorkshop.Domain.Entities.CarWorkshop", b =>
                {
                    b.HasOne("Shared.ApplicationUser.ApplicationUser", "CreatedBy")
                        .WithMany()
                        .HasForeignKey("CreatedById");

                    b.OwnsOne("CarWorkshop.Domain.Entities.CarWoskshopContactDetails", "ContactDetails", b1 =>
                        {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Shared.ApplicationUser.ApplicationUser", null)
                        .WithMany()
